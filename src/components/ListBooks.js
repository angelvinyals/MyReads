                ...
                <div className="list-books-content">
                  <div>
                    ...
                    <div className="bookshelf">
                      	...
                      	<div className="bookshelf-books">          					
          					<ol className="books-grid">         						
          						{this.props.books2.filter((book) => book.shelf==="currentlyReading").map((b) =>   							
                                    <li key={b.id}>
                    ...
                    <div className="bookshelf">
                      ...
                      <div className="bookshelf-books">
                        <ol className="books-grid">
							{this.props.books2.filter((book) => book.shelf==="wantToRead").map((b) =>            								        														<li key={b.id}>
          								<Book book={b} onChangeShelf={this.handleChangeShelf} shelf={b.shelf} />
          							</li>  
                            )}                         
                        </ol>
                    ...
                    <div className="bookshelf">
                      ...
                      <div className="bookshelf-books">
                        <ol className="books-grid">
							{this.props.books2.filter((book) => book.shelf==="read").map((b) =>            								        						
                             	<li key={b.id}>
          								<Book book={b} onChangeShelf={this.handleChangeShelf} shelf={b.shelf} />
          						</li>  
                             )}                                                     
